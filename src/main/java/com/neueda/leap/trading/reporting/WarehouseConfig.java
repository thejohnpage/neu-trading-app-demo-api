...
public class WarehouseConfig {
 ...
 @Bean(name="warehouseSqlSessionFactory") SqlSessionFactory warehouseSqlSessionFactory(@Qualifier("warehouseDataSource")DataSource ds)throws Exception{SqlSessionFactoryBean bean=new SqlSessionFactoryBean();bean.setDataSource(ds);return bean.getObject();}
}